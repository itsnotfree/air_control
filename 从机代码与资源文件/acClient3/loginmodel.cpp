...
void loginModel::login1(QString roomnumber, QString id)
{
    ...
    socket->connectToHost("192.168.43.201",6666);
    ...
    {
        //QMessageBox::information(NULL, "对不起", "无法登陆", QMessageBox::Yes, QMessageBox::Yes);
        emit msg("无法连接");
    }
}
...
void loginModel::revData()
{
    ...
    if(QString::compare(QString(list[0]),"serverMsg")==0)
        {
